...
namespace MyTripMVC.Migrations
{
    ...
    [Migration("20230911100058_Initiate migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyTripMVC.Models.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AltTag = "A buildning with a ship on top",
                            CityId = 1,
                        ...
                        {
                            Id = 3,
                            AltTag = "The building of Bonniers konsthall",
                            CityId = 1,
                        ...
                        {
                            Id = 4,
                            AltTag = "Animated image of the amusement park during the evening",
                            CityId = 2,
                        ...
                        {
                            Id = 7,
                            AltTag = "Two ladies walking in a the garden.",
                            CityId = 3,
                        ...
                        {
                            Id = 8,
                            AltTag = "Overlooking the garden infront of a building",
                            CityId = 3,
                        ...
                        {
                            Id = 9,
                            AltTag = "Old church in middle of Uppsala",
                            CityId = 3,
                        ...
                        {
                            Id = 10,
                            AltTag = "Image of a pond with a willow tree next to it.",
                            CityId = 4,
                        ...
                        {
                            Id = 11,
                            AltTag = "People riding bikes on the street.",
                            CityId = 4,
                        ...
                        {
                            Id = 12,
                            AltTag = "Overhead view of a castle in Malmö",
                            CityId = 4,
                        ...
                        {
                            Id = 13,
                            AltTag = "Aurora borialis on the night sky",
                            CityId = 5,
                        ...
                        {
                            Id = 15,
                            AltTag = "The inside of a mine with blue lights along the walls.",
                            CityId = 5,
            ...
            modelBuilder.Entity("MyTripMVC.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyTripMVC.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyTripMVC.Models.Restaurant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2000,
                            AltTag = "Laid tables at Linglong",
                            CityId = 1,
                        ...
                        {
                            Id = 4000,
                            AltTag = "Tabel with different cusines",
                            CityId = 2,
                        ...
                        {
                            Id = 5000,
                            AltTag = "Laid tables at Panos Panos Tavern",
                            CityId = 2,
                        ...
                        {
                            Id = 7000,
                            AltTag = "Laid tables at Aaltos Italian Grill",
                            CityId = 3,
                            ...
                            Name = "Aaltos Italian Grill"
                        },
                        new
                        {
                            Id = 8000,
                            AltTag = "Laid tables at Hambergs Fisk",
                            CityId = 3,
                        ...
                        {
                            Id = 9000,
                            AltTag = "Laid tables at Miss Voon",
                            CityId = 3,
                        ...
                        {
                            Id = 1100,
                            AltTag = "Laid tables at Vollmers",
                            CityId = 4,
                        ...
                        {
                            Id = 1300,
                            AltTag = "Overlooking the bar at Lyran Matbar",
                            CityId = 4,
                        ...
                        {
                            Id = 1400,
                            AltTag = "Cheeseburger without bacon",
                            CityId = 5,
            ...
            modelBuilder.Entity("MyTripMVC.Models.UserActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyTripMVC.Models.UserRestaurant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyTripMVC.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyTripMVC.Models.Activity", b =>
                {
                    b.HasOne("MyTripMVC.Models.City", "City")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("MyTripMVC.Models.UserActivity", b =>
                {
                    b.HasOne("MyTripMVC.Models.Activity", "Activity")
                        .WithMany("UserActivities")
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyTripMVC.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("MyTripMVC.Models.UserRestaurant", b =>
                {
                    b.HasOne("MyTripMVC.Models.Restaurant", "Restaurant")
